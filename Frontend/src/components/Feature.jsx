        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-400 mb-6">
                Our system analyzes tokens before you swap, providing a comprehensive risk score to protect you from potential scams and financial losses.
              </p>
              <ul className="space-y-4 text-left">
                <FeatureListItem>
                  <strong>Real-Time Analysis:</strong> Scans contracts and transaction histories for malicious code and suspicious patterns.
                </FeatureListItem>
                <FeatureListItem>
                  <strong>Comprehensive Risk Score:</strong> Get clear warnings on honeypots, rug pulls, and abnormal trading activity.
                </FeatureListItem>
                <FeatureListItem>
                  <strong>Continuous Learning:</strong> Our detection models are constantly updated to counter the latest threats in the crypto space.
                </FeatureListItem>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left md:order-last">
              ...
              <p className="text-gray-400 mb-6">
                An intuitive interface built on the high-speed Aptos blockchain, ensuring every transaction is fast, cheap, and transparent.
              </p>
              <ul className="space-y-4 text-left">
                <FeatureListItem>
                  <strong>Intuitive Interface:</strong> Displays real-time price feeds, slippage, and fees before you confirm any transaction.
                </FeatureListItem>
                <FeatureListItem>
                  <strong>High-Speed & Low-Cost:</strong> Leverages the efficiency of Aptos for near-instant execution and minimal fees.
                </FeatureListItem>
                <FeatureListItem>
                  <strong>Transparent Analytics:</strong> Access a complete breakdown of your swap history and performance in your dashboard.
                </FeatureListItem>
              </ul>
            </div>
              ...
              <div className="bg-[#18181c]/80 backdrop-blur-sm rounded-3xl shadow-2xl p-6 border border-[#23232a] w-full max-w-sm">
                <div className="rounded-2xl bg-[#111112] p-5 mb-2">
                  <div className="flex items-center justify-between">
                    <div className="text-3xl font-semibold text-white/80">1,000</div>
                    <div className="flex items-center bg-cyan-600 text-white rounded-full px-4 py-2 font-medium text-lg">APT</div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl bg-[#111112] p-5 mt-2">
                  <div className="flex items-center justify-between">
                    <div className="text-3xl font-semibold text-white/80">3,408</div>
                    <div className="flex items-center bg-pink-500 text-white rounded-full px-4 py-2 font-medium text-lg">USDC</div>
                  </div>
                </div>
              </div>
            </div>
