          ...
          <div className="bg-[#1c1c24] rounded-2xl p-6 border border-[#2a2a35] shadow-lg">
            ...
            <div className="mb-4">
              ...
              <div className="flex bg-[#111112] rounded-xl p-3 border border-[#2a2a35] focus-within:border-cyan-600 transition">
                <button className="flex items-center space-x-2 bg-[#1c1c24] px-3 py-2 rounded-lg border border-[#2a2a35] hover:border-cyan-600 transition" onClick={() => setShowTokenModal("from")}>
            ...
            <div className="mb-4 mt-2">
              ...
              <div className="flex bg-[#111112] rounded-xl p-3 border border-[#2a2a35] focus-within:border-cyan-600 transition">
                <button className="flex items-center space-x-2 bg-[#1c1c24] px-3 py-2 rounded-lg border border-[#2a2a35] hover:border-cyan-600 transition" onClick={() => setShowTokenModal("to")}>
