...
exports.useWalletProviderStore = (0, pinia_1.defineStore)('walletProviderStore', () => {
    ...
    function connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(selectedWallet.adapter.readyState === WalletAdapters_1.WalletReadyState.Installed ||
                ...
                setWalletName(null);
                if (typeof window !== 'undefined' && selectedWallet.adapter.url && !(0, helpers_1.isMobile)()) {
            ...
            try {
                ...
                if (selectedWallet.adapter.name === 'Msafe') {
                    account.value = yield selectedWallet.adapter.account();
                }
                else {
    ...
    (0, vue_1.watch)([connecting, connected, readyState, autoConnect], () => {
        if (connecting.value ||
            connected.value ||
            !autoConnect.value ||
