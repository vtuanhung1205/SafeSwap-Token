...
var SuiTransaction = union3([
  ...
  object4({
    Upgrade: tuple([SuiMovePackage, array3(ObjectId), ObjectId, SuiArgument])
  }),
...
var Validators = array6(tuple2([AuthorityName, string8()]));
...
var SuiSystemStateSummary = object8({
  ...
  atRiskValidators: array6(tuple2([SuiAddress, string8()])),
...
var EndOfEpochData = object11({
  nextEpochCommittee: array9(tuple3([string11(), string11()])),
...
// src/builder/Transactions.ts
var option = (some) => union7([object14({ None: literal8(null) }), object14({ Some: some })]);
