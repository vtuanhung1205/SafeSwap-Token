...
var SuiTransaction = (0, import_superstruct4.union)([
  ...
  (0, import_superstruct4.object)({
    Upgrade: (0, import_superstruct4.tuple)([SuiMovePackage, (0, import_superstruct4.array)(ObjectId), ObjectId, SuiArgument])
  }),
...
var GasCostSummary2 = (0, import_superstruct11.object)({
  computationCost: (0, import_superstruct11.string)(),
  storageCost: (0, import_superstruct11.string)(),
  storageRebate: (0, import_superstruct11.string)(),
  nonRefundableStorageFee: (0, import_superstruct11.string)()
});
var CheckPointContentsDigest = (0, import_superstruct11.string)();
var CheckpointDigest = (0, import_superstruct11.string)();
var ECMHLiveObjectSetDigest = (0, import_superstruct11.object)({
  digest: (0, import_superstruct11.array)((0, import_superstruct11.number)())
});
var CheckpointCommitment = (0, import_superstruct11.any)();
var ValidatorSignature = (0, import_superstruct11.string)();
var EndOfEpochData = (0, import_superstruct11.object)({
  nextEpochCommittee: (0, import_superstruct11.array)((0, import_superstruct11.tuple)([(0, import_superstruct11.string)(), (0, import_superstruct11.string)()])),
  nextEpochProtocolVersion: (0, import_superstruct11.string)(),
  epochCommitments: (0, import_superstruct11.array)(CheckpointCommitment)
});
var ExecutionDigests = (0, import_superstruct11.object)({
  transaction: TransactionDigest,
  effects: TransactionEffectsDigest
});
var Checkpoint = (0, import_superstruct11.object)({
  epoch: (0, import_superstruct11.string)(),
  sequenceNumber: (0, import_superstruct11.string)(),
  digest: CheckpointDigest,
  networkTotalTransactions: (0, import_superstruct11.string)(),
  previousDigest: (0, import_superstruct11.optional)(CheckpointDigest),
  epochRollingGasCostSummary: GasCostSummary2,
  timestampMs: (0, import_superstruct11.string)(),
  endOfEpochData: (0, import_superstruct11.optional)(EndOfEpochData),
  // TODO(jian): remove optional after 0.30.0 is released
  validatorSignature: (0, import_superstruct11.optional)(ValidatorSignature),
  transactions: (0, import_superstruct11.array)(TransactionDigest),
  checkpointCommitments: (0, import_superstruct11.array)(CheckpointCommitment)
});
var CheckpointPage = (0, import_superstruct11.object)({
  data: (0, import_superstruct11.array)(Checkpoint),
...
// src/version.ts
var PACKAGE_VERSION = "0.32.2";
var TARGETED_RPC_VERSION = "0.34.0";
...
// src/rpc/client.ts
var ValidResponse = (0, import_superstruct12.object)({
  jsonrpc: (0, import_superstruct12.literal)("2.0"),
  id: (0, import_superstruct12.string)(),
  result: (0, import_superstruct12.any)()
});
var ErrorResponse = (0, import_superstruct12.object)({
  jsonrpc: (0, import_superstruct12.literal)("2.0"),
  id: (0, import_superstruct12.string)(),
  error: (0, import_superstruct12.object)({
    code: (0, import_superstruct12.any)(),
    message: (0, import_superstruct12.string)(),
    data: (0, import_superstruct12.optional)((0, import_superstruct12.any)())
  })
});
var JsonRpcClient = class {
  ...
  async requestWithType(method, args, struct) {
    ...
    if ((0, import_superstruct12.is)(response, ErrorResponse)) {
      throw new RPCError({
        req,
    ...
    } else if ((0, import_superstruct12.is)(response, ValidResponse)) {
      const [err] = (0, import_superstruct12.validate)(response.result, struct);
      if (err) {
        console.warn(
...
var DynamicFieldType = (0, import_superstruct13.union)([
  (0, import_superstruct13.literal)("DynamicField"),
  (0, import_superstruct13.literal)("DynamicObject")
]);
var DynamicFieldName = (0, import_superstruct13.object)({
  type: (0, import_superstruct13.string)(),
  value: (0, import_superstruct13.any)()
});
var DynamicFieldInfo = (0, import_superstruct13.object)({
  name: DynamicFieldName,
  bcsName: (0, import_superstruct13.string)(),
  type: DynamicFieldType,
  objectType: (0, import_superstruct13.string)(),
  objectId: ObjectId,
  version: (0, import_superstruct13.number)(),
  digest: (0, import_superstruct13.string)()
});
var DynamicFieldPage = (0, import_superstruct13.object)({
  data: (0, import_superstruct13.array)(DynamicFieldInfo),
  nextCursor: (0, import_superstruct13.nullable)(ObjectId),
...
var WebsocketClient = class {
  ...
  onSocketMessage(rawMessage) {
    ...
    if (msg.method === SUBSCRIBE_EVENT_METHOD) {
      ...
      } else if ((0, import_superstruct14.is)(params, SubscriptionEvent)) {
        const sub = this.eventSubscriptions.get(params.subscription);
        if (sub)
          sub.onMessage(params.result);
      }
...
function create(value, struct) {
  return (0, import_superstruct15.create)(value, struct);
}
var TRANSACTION_TYPE = Symbol("transaction-argument-type");

// src/builder/Transactions.ts
var option = (some) => (0, import_superstruct16.union)([(0, import_superstruct16.object)({ None: (0, import_superstruct16.literal)(null) }), (0, import_superstruct16.object)({ Some: some })]);
var TransactionBlockInput = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("Input"),
  index: (0, import_superstruct16.integer)(),
  value: (0, import_superstruct16.optional)((0, import_superstruct16.any)()),
  type: (0, import_superstruct16.optional)((0, import_superstruct16.union)([(0, import_superstruct16.literal)("pure"), (0, import_superstruct16.literal)("object")]))
});
var TransactionArgumentTypes = [
  TransactionBlockInput,
  (0, import_superstruct16.object)({ kind: (0, import_superstruct16.literal)("GasCoin") }),
  (0, import_superstruct16.object)({ kind: (0, import_superstruct16.literal)("Result"), index: (0, import_superstruct16.integer)() }),
  (0, import_superstruct16.object)({
    kind: (0, import_superstruct16.literal)("NestedResult"),
    index: (0, import_superstruct16.integer)(),
    resultIndex: (0, import_superstruct16.integer)()
  })
];
var TransactionArgument = (0, import_superstruct16.union)([...TransactionArgumentTypes]);
var ObjectTransactionArgument = (0, import_superstruct16.union)([...TransactionArgumentTypes]);
ObjectTransactionArgument[TRANSACTION_TYPE] = {
  kind: "object"
};
var PureTransactionArgument = (type) => {
  const struct = (0, import_superstruct16.union)([...TransactionArgumentTypes]);
...
var MoveCallTransaction = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("MoveCall"),
  target: (0, import_superstruct16.define)(
    "target",
    (0, import_superstruct16.string)().validator
  ),
  typeArguments: (0, import_superstruct16.array)((0, import_superstruct16.string)()),
  arguments: (0, import_superstruct16.array)(TransactionArgument)
});
var TransferObjectsTransaction = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("TransferObjects"),
  objects: (0, import_superstruct16.array)(ObjectTransactionArgument),
  address: PureTransactionArgument(import_bcs11.BCS.ADDRESS)
});
var SplitCoinsTransaction = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("SplitCoins"),
  coin: ObjectTransactionArgument,
  amounts: (0, import_superstruct16.array)(PureTransactionArgument("u64"))
});
var MergeCoinsTransaction = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("MergeCoins"),
  destination: ObjectTransactionArgument,
  sources: (0, import_superstruct16.array)(ObjectTransactionArgument)
});
var MakeMoveVecTransaction = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("MakeMoveVec"),
  type: (0, import_superstruct16.optional)(option((0, import_superstruct16.string)())),
  objects: (0, import_superstruct16.array)(ObjectTransactionArgument)
});
var PublishTransaction = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("Publish"),
  modules: (0, import_superstruct16.array)((0, import_superstruct16.array)((0, import_superstruct16.integer)())),
  dependencies: (0, import_superstruct16.array)(ObjectId)
});
...
var UpgradeTransaction = (0, import_superstruct16.object)({
  kind: (0, import_superstruct16.literal)("Upgrade"),
  modules: (0, import_superstruct16.array)((0, import_superstruct16.array)((0, import_superstruct16.integer)())),
  dependencies: (0, import_superstruct16.array)(ObjectId),
  packageId: ObjectId,
...
var TransactionType = (0, import_superstruct16.union)([...TransactionTypes]);
function getTransactionType(data) {
  (0, import_superstruct16.assert)(data, TransactionType);
  return TransactionTypes.find((schema) => (0, import_superstruct16.is)(data, schema));
}
var Transactions = {
  MoveCall(input) {
    return create(
...
// src/builder/Inputs.ts
var ObjectArg = (0, import_superstruct17.union)([
  (0, import_superstruct17.object)({ ImmOrOwned: SuiObjectRef }),
  (0, import_superstruct17.object)({
    Shared: (0, import_superstruct17.object)({
      objectId: (0, import_superstruct17.string)(),
      initialSharedVersion: (0, import_superstruct17.union)([(0, import_superstruct17.integer)(), (0, import_superstruct17.string)()]),
      mutable: (0, import_superstruct17.boolean)()
    })
  })
]);
var PureCallArg = (0, import_superstruct17.object)({ Pure: (0, import_superstruct17.array)((0, import_superstruct17.integer)()) });
var ObjectCallArg = (0, import_superstruct17.object)({ Object: ObjectArg });
var BuilderCallArg = (0, import_superstruct17.union)([PureCallArg, ObjectCallArg]);
var Inputs = {
  Pure(data, type) {
    return {
      Pure: Array.from(
...
var SuiAddress3 = (0, import_superstruct18.string)();
...
var NetworkMetrics = (0, import_superstruct20.object)({
  currentTps: (0, import_superstruct20.number)(),
  tps30Days: (0, import_superstruct20.number)(),
  currentCheckpoint: (0, import_superstruct20.string)(),
  currentEpoch: (0, import_superstruct20.string)(),
  totalAddresses: (0, import_superstruct20.string)(),
  totalObjects: (0, import_superstruct20.string)(),
  totalPackages: (0, import_superstruct20.string)()
});
...
var JsonRpcProvider = class {
  ...
  async getRpcApiVersion() {
    ...
    try {
      const resp = await this.client.requestWithType("rpc.discover", [], (0, import_superstruct21.any)());
