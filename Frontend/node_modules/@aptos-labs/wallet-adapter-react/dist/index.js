...
function createHeadlessComponent(displayName, elementType, props) {
  const component = (0, import_react6.forwardRef)(({ className, asChild, children }, ref) => {
    ...
    const resolvedChildren = asChild && (0, import_react6.isValidElement)(children) && !children.props.children ? (0, import_react6.cloneElement)(children, {}, defaultChildren) : children != null ? children : defaultChildren;
