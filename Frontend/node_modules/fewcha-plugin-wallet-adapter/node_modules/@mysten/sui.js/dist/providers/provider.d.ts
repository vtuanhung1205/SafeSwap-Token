...
export declare abstract class Provider {
     ...
     */
    abstract getTransactions(query: TransactionQuery, cursor: TransactionDigest | null, limit: number | null, order: Ordering): Promise<PaginatedTransactionDigests>;
    /**
     ...
     * Gateway
     */
    abstract executeTransactionWithRequestType(txnBytes: string, signatureScheme: SignatureScheme, signature: string, pubkey: string, requestType: ExecuteTransactionRequestType): Promise<SuiExecuteTransactionResponse>;
    /**
     ...
     */
    abstract getEventsByModule(packageId: ObjectId, module: string, count: number, startTime: number, endTime: number): Promise<SuiEvents>;
    /**
     ...
     */
    abstract getEventsByMoveEventStructName(moveEventStructName: string, count: number, startTime: number, endTime: number): Promise<SuiEvents>;
    /**
     ...
     * @param endTime end of time range
     */
    abstract getEventsBySender(sender: SuiAddress, count: number, startTime: number, endTime: number): Promise<SuiEvents>;
    /**
     ...
     * @param endTime end of time range
     */
    abstract getEventsByRecipient(recipient: ObjectOwner, count: number, startTime: number, endTime: number): Promise<SuiEvents>;
    /**
     ...
     * @param endTime end of time range
     */
    abstract getEventsByObject(object: ObjectId, count: number, startTime: number, endTime: number): Promise<SuiEvents>;
    /**
     ...
     * @param endTime end of time range
     */
    abstract getEventsByTimeRange(count: number, startTime: number, endTime: number): Promise<SuiEvents>;
    /**
