...
export interface TxnDataSerializer {
    ...
    newPay(signerAddress: SuiAddress, txn: PayTransaction): Promise<Base64DataBuffer>;
    ...
    newPublish(signerAddress: SuiAddress, txn: PublishTransaction): Promise<Base64DataBuffer>;
}
