...
export declare type TransactionKindName = 'TransferObject' | 'Publish' | 'Call' | 'TransferSui' | 'ChangeEpoch' | 'Pay';
...
export declare type GetTxnDigestsResponse__DEPRECATED = [
    GatewayTxSeqNumber,
    TransactionDigest
][];
...
export declare type Ordering = 'Ascending' | 'Descending';
...
export declare function getExecutionStatusGasSummary(data: SuiTransactionResponse | SuiExecuteTransactionResponse): GasCostSummary | undefined;
export declare function getTotalGasUsed(data: SuiTransactionResponse | SuiExecuteTransactionResponse): number | undefined;
