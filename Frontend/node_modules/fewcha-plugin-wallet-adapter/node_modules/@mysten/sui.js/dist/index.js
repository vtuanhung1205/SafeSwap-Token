...
__export(src_exports, {
  ...
  bcs: () => import_bcs.bcs,
  checkPublicKeyData: () => checkPublicKeyData,
  ...
  isGetTxnDigestsResponse__DEPRECATED: () => isGetTxnDigestsResponse__DEPRECATED,
...
var Base64DataBuffer = class {
  constructor(data) {
    if (typeof data === "string") {
      this.data = new Uint8Array(import_buffer.Buffer.from(data, "base64"));
    } else {
      this.data = data;
    }
  }
  ...
  toString() {
    return import_buffer.Buffer.from(this.data).toString("base64");
  }
};
...
var Ed25519PublicKey = class {
  ...
  toBuffer() {
    ...
    const zeroPad = import_buffer2.Buffer.alloc(PUBLIC_KEY_SIZE);
...
var Secp256k1PublicKey = class {
  constructor(value) {
    if (checkPublicKeyData(value)) {
      ...
      if (typeof value === "string") {
        const buffer = import_buffer3.Buffer.from(value, "base64");
        ...
        this._bn = new import_bn2.default(buffer);
      } else {
  ...
  toBuffer() {
    ...
    const zeroPad = import_buffer3.Buffer.alloc(SECP256K1_PUBLIC_KEY_SIZE);
...
function isTransactionKindName(obj, _argumentName) {
  return obj === "Publish" || obj === "TransferObject" || obj === "Call" || obj === "TransferSui" || obj === "ChangeEpoch" || obj === "Pay";
}
function isSuiTransactionKind(obj, _argumentName) {
  return (obj !== null && typeof obj === "object" || typeof obj === "function") && isTransferObject(obj.TransferObject) || (obj !== null && typeof obj === "object" || typeof obj === "function") && isSuiMovePackage(obj.Publish) || (obj !== null && typeof obj === "object" || typeof obj === "function") && isMoveCall(obj.Call) || (obj !== null && typeof obj === "object" || typeof obj === "function") && isSuiTransferSui(obj.TransferSui) || (obj !== null && typeof obj === "object" || typeof obj === "function") && isSuiChangeEpoch(obj.ChangeEpoch) || (obj !== null && typeof obj === "object" || typeof obj === "function") && isPay(obj.Pay);
}
...
function isGetTxnDigestsResponse__DEPRECATED(obj, _argumentName) {
  return Array.isArray(obj) && obj.every(
    (e) => Array.isArray(e) && isSuiMoveTypeParameterIndex(e[0]) && isTransactionDigest(e[1])
  );
}
...
function isObjectArg(obj, _argumentName) {
  return (obj !== null && typeof obj === "object" || typeof obj === "function") && isSuiObjectRef(obj.ImmOrOwned) || (obj !== null && typeof obj === "object" || typeof obj === "function") && isTransactionDigest(obj.Shared);
}
function isCallArg(obj, _argumentName) {
  return (obj !== null && typeof obj === "object" || typeof obj === "function") && (obj.Pure !== null && typeof obj.Pure === "object" || typeof obj.Pure === "function") && isSuiMoveTypeParameterIndex(obj.Pure.length) || (obj !== null && typeof obj === "object" || typeof obj === "function") && isObjectArg(obj.Object);
}
...
function isTransaction(obj, _argumentName) {
  return isTransferObjectTx(obj) || isTransferSuiTx(obj) || isPayTx(obj) || isPublishTx(obj) || isMoveCallTx(obj);
}
...
import_bcs.bcs.registerVectorType("vector<u8>", "u8").registerVectorType("vector<u64>", "u64").registerVectorType("vector<u128>", "u128").registerVectorType("vector<vector<u8>>", "vector<u8>").registerAddressType("ObjectID", 20).registerAddressType("SuiAddress", 20).registerAddressType("address", 20).registerType(
  "utf8string",
  (writer, str) => {
    let bytes = Array.from(import_buffer4.Buffer.from(str));
    return writer.writeVec(bytes, (writer2, el) => writer2.write8(el));
  },
  (reader) => {
    let bytes = reader.readVec((reader2) => reader2.read8());
    return import_buffer4.Buffer.from(bytes).toString("utf-8");
  }
).registerType(
  "ObjectDigest",
  (writer, str) => {
    let bytes = Array.from((0, import_bcs.decodeStr)(str, "base64"));
    return writer.writeVec(bytes, (writer2, el) => writer2.write8(el));
  },
  (reader) => {
    let bytes = reader.readVec((reader2) => reader2.read8());
    return (0, import_bcs.encodeStr)(new Uint8Array(bytes), "base64");
  }
);
import_bcs.bcs.registerStructType("SuiObjectRef", {
  objectId: "ObjectID",
  version: "u64",
  digest: "ObjectDigest"
});
import_bcs.bcs.registerStructType("TransferObjectTx", {
  recipient: "SuiAddress",
  object_ref: "SuiObjectRef"
});
import_bcs.bcs.registerVectorType("vector<SuiAddress>", "SuiAddress").registerVectorType("vector<SuiObjectRef>", "SuiObjectRef").registerStructType("PayTx", {
  coins: "vector<SuiObjectRef>",
  recipients: "vector<SuiAddress>",
  amounts: "vector<u64>"
});
import_bcs.bcs.registerEnumType("Option<u64>", {
  None: null,
  Some: "u64"
});
import_bcs.bcs.registerStructType("TransferSuiTx", {
  recipient: "SuiAddress",
  amount: "Option<u64>"
});
import_bcs.bcs.registerStructType("PublishTx", {
  modules: "vector<vector<u8>>"
});
import_bcs.bcs.registerEnumType("ObjectArg", {
...
import_bcs.bcs.registerEnumType("TypeTag", {
  bool: null,
  u8: null,
  u64: null,
  u128: null,
...
import_bcs.bcs.registerVectorType("vector<CallArg>", "CallArg").registerStructType("MoveCallTx", {
...
import_bcs.bcs.registerEnumType("Transaction", {
...
import_bcs.bcs.registerVectorType("vector<Transaction>", "Transaction").registerEnumType("TransactionKind", {
  Single: "Transaction",
  Batch: "vector<Transaction>"
});
import_bcs.bcs.registerStructType("TransactionData", {
...
var isAny = (_val) => true;
var PRE_PAGINATION_API_VERSION = "0.11.0";
var LATEST_RPC_API_VERSION = "latest";
var JsonRpcProvider = class extends Provider {
  constructor(endpoint, skipDataValidation = true, rpcAPIVersion = PRE_PAGINATION_API_VERSION, socketOptions = DEFAULT_CLIENT_OPTIONS) {
    super();
    this.endpoint = endpoint;
    this.skipDataValidation = skipDataValidation;
    this.rpcAPIVersion = rpcAPIVersion;
  ...
  async getTransactions(query, cursor, limit, order) {
    try {
      return await this.client.requestWithType(
        "sui_getTransactions",
  ...
  async executeTransaction(txnBytes, signatureScheme, signature, pubkey) {
    try {
      const resp = await this.client.requestWithType(
  ...
  async getEventsByModule(package_, module2, count = EVENT_QUERY_MAX_LIMIT, startTime = DEFAULT_START_TIME, endTime = DEFAULT_END_TIME) {
    try {
      return await this.client.requestWithType(
        "sui_getEventsByModule",
        [package_, module2, count, startTime, endTime],
        isSuiEvents,
        this.skipDataValidation
      );
    } catch (err) {
      throw new Error(
        `Error getting events by transaction module: ${package_}::${module2}, with error: ${err}`
      );
    }
  }
...
var HexDataBuffer = class {
  constructor(data) {
    if (typeof data === "string") {
      this._data = new Uint8Array(import_buffer5.Buffer.from(data, "hex"));
    } else {
      this._data = data;
    }
  }
  ...
  toString() {
    return import_buffer5.Buffer.from(this._data).toString("hex");
  }
};
...
var CallArgSerializer = class {
  ...
  async extractObjectIds(txn) {
    ...
    return args.map((arg) => {
      if ("Object" in arg) {
        ...
        return "Shared" in objectArg ? objectArg.Shared : objectArg.ImmOrOwned.objectId;
      }
      return null;
    }).filter((a) => a != null);
  }
  async serializeMoveCallArguments(txn) {
    ...
    const userParams = hasTxContext ? params.slice(0, params.length - 1) : params;
  ...
  async newCallArg(expectedType, argVal) {
    ...
    return {
      Pure: import_bcs.bcs.ser(serType, argVal).toBytes()
    };
  }
  getPureSerializationType(normalizedType, argVal) {
    ...
    if ("Vector" in normalizedType) {
      ...
      import_bcs.bcs.registerVectorType(res, innerType);
      return res;
    }
    throw new Error(
...
var LocalTxnDataSerializer = class {
  ...
  serializeTransactionData(tx, size = 2048) {
    const dataBytes = import_bcs.bcs.ser("TransactionData", tx, size).toBytes();
...
var VoidProvider = class extends Provider {
  ...
  async executeTransaction(_txnBytes, _signatureScheme, _signature, _pubkey) {
