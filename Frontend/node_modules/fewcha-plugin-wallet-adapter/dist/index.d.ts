...
declare class FewchaWallet implements AdapterPlugin {
    ...
    signTransaction(transaction: Types.TransactionPayload, options?: any): Promise<Uint8Array | null>;
    signAndSubmitBCSTransaction(_transaction: TxnBuilderTypes.TransactionPayload, _options?: any): Promise<{
        hash: Types.HexEncodedBytes;
    }>;
...
export { FewchaWallet, FewchaWalletName };
