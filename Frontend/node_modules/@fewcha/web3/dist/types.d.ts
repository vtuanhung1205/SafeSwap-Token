...
export interface Web3ProviderType {
    ...
    generateSignSubmitTransaction(payload: Gen.EntryFunctionPayload, extraArgs?: OptionalTransactionArgs): Promise<Response<Gen.HexEncodedBytes>>;
    generateSignSubmitRawTransaction(payload: Uint8Array, options?: Partial<Gen.SubmitTransactionRequest>): Promise<Response<Gen.HexEncodedBytes>>;
    generateSignSubmitWaitForTransaction(payload: Uint8Array, extraArgs?: {
    ...
    simulateTransaction(rawTransaction: Uint8Array, query?: {
    ...
    sdk: Web3SDK;
    token: Web3Token;
    fewchaCoin: FewchaWeb3Coin;
}
export declare type Web3SDK = {
    ...
    getAccountModules(accountAddress: MaybeHexString, query?: {
        ledgerVersion?: BCS.AnyNumber;
    }): Promise<Response<Gen.MoveModuleBytecode[]>>;
...
export declare type FewchaWeb3Coin = {
